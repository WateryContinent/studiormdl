...
// Internal helper with 2-arg signature (used by _recalloc_crt below)
static void *_recalloc_base_internal( void *pMem, size_t nSize )
{
...
// VS2022+ CRT declares _recalloc_base with 3 arguments; match that signature
void *_recalloc_base( void *pMem, size_t nCount, size_t nSize )
{
	return _recalloc_base_internal( pMem, nCount * nSize );
}
#else
void *_recalloc_base( void *pMem, size_t nSize )
{
	return _recalloc_base_internal( pMem, nSize );
}
#endif
