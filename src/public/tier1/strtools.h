...
// Force <cctype> to be included before redefining isXXX macros.
// In VS2022/C++17, <cctype> does `using ::isalnum;` etc. into std:: namespace.
// If these macros are already in effect when <cctype> is included later by any
// C++ header, it causes C2039/C2873 errors because `using ::use_V_isXXX...`
// tries to bring a nonexistent symbol into std::. Include <cctype> here first
// so those using-declarations happen while the original C names are intact.
#ifdef __cplusplus
#include <cctype>
#endif
